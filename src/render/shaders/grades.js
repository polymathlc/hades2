...
export const GRADES = {
  ...
  tartarus: {
    ...
    // ROUND-2 (§15.1): every chroma multiplier in this grade sat UNDER 1.0 — the bleach
    // pass §15 was written to ban, still shipping. Measured meanSaturation was
    // 0.248-0.276 on every Tartarus frame against the 0.42 floor. The palette now
    // carries the chroma (stone ramp, floor per-flag colour); these only stop the
